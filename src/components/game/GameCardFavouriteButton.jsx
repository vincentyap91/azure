...
export default function GameCardFavouriteButton({
    ...
    return (
        <button
            ...
            className={`absolute right-2 top-2 z-40 flex ${dim} items-center justify-center rounded-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgb(117_207_255)] ${active ? activeClasses : inactiveClasses} ${className}`}
            aria-pressed={active}
